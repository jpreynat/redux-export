...
You can also enable the [object spread operator proposal](recipes/using-object-spread-operator.md) for a more succinct syntax:
...
The fix is to call [`dispatch()`](api-reference/store.md#dispatch) method on the [store](api-reference/store.md) instance:
